use opencode_multiplexer::terminal::{
    ...
    selection::{TerminalSelection, SelectionPoint, SelectionRange, extract_selection_text},
...
fn reverse_drag_extracts_same_text() {
    ...
    assert_eq!(extract_selection_text(&snapshot, range_fwd, &surface.wrapped_rows()), "hello\nworld");
}
